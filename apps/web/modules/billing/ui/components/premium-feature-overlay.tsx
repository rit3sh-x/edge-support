...
import { BookOpenIcon, BotIcon, GemIcon, type LucideIcon, MicIcon, PaletteIcon, PhoneIcon, UsersIcon } from "lucide-react";
...
const features: Feature[] = [
    ...
    },
    {
        ...
        description: "Add custom options for users to interact with your bot"
    },
];
            ...
            <div className="absolute inset-0 z-40 flex items-center justify-center p-4">
                <Card className="w-full max-w-md">
                    <CardHeader className="text-center">
                        ...
                        <CardDescription>This feature requires pro subscription</CardDescription>
                    </CardHeader>
