...
import { Card, CardHeader, CardDescription, CardTitle } from "@workspace/ui/components/card";
...
export const VapiConnectedView = ({ onDisconnect }: VapiConnectedViewProps) => {
    const [activeTab, setActiveTab] = useState<"phone-numbers" | "assistants">("phone-numbers");
        ...
        <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <CardDescription>Setup voice calls for your widget chat</CardDescription>
                            </div>
                        </div>
                        <Button asChild>
            ...
            <div className="overflow-hidden rounded-lg border bg-background">
                <Tabs
                    ...
                    value={activeTab}
                    onValueChange={(value) => setActiveTab(value as "phone-numbers" | "assistants")}
                >
