...
import { DeletFileDialog } from "../components/delete-file-dialog";
...
export const FilesView = () => {
    ...
    const { canLoadMore, handleLoadMore, isLoadingFirstPage, isLoadingMore, topElementRef } = useInfiniteScroll({
    ...
    return (
        <>
            ...
            <DeletFileDialog onOpenChange={setDeleteDialogOpen} open={deleteDialogOpen} file={selectedFile} onDeleted={handleFileDeleted} />
            <div className="flex min-h-screen flex-col bg-muted p-8">
                <div className="mx-auto w-full max-w-screen-md">
                    <div className="space-y-2">
                        <h1 className="text-2xl md:text-4xl">Knowledge Base</h1>
                        <p className="text-muted-foreground">Upload and manage documents for you AI assistant</p>
                    </div>
